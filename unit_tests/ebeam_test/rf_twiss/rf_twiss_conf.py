...
bb_393_b2 = Bend(
    l=l_bc2, angle=phi_bc2, e1=0.0, e2=phi_bc2, tilt=1.570796330, eid="bb_393_b2"
)
bb_402_b2 = Bend(
    l=l_bc2, angle=-phi_bc2, e1=-phi_bc2, e2=0.0, tilt=1.570796330, eid="bb_402_b2"
)
bb_404_b2 = Bend(
    l=l_bc2, angle=-phi_bc2, e1=0.0, e2=-phi_bc2, tilt=1.570796330, eid="bb_404_b2"
)
bb_413_b2 = Bend(
    l=l_bc2, angle=phi_bc2, e1=phi_bc2, e2=0.0, tilt=1.570796330, eid="bb_413_b2"
)
...
c_a3 = Cavity(l=1.0377000, phi=0.0, v=ac_v, freq=1.300e009, eid="c_a3")
