...
# undulator
UNDU_49_I1 = Undulator(
    lperiod=0.074, nperiods=10, Kx=1.36 * 1.414213, Ky=0.0, eid="UNDU.49.I1"
)
...
C3_AH1_1_1_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.1.I1"
)
C3_AH1_1_2_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.2.I1"
)
C3_AH1_1_3_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.3.I1"
)
C3_AH1_1_4_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.4.I1"
)
C3_AH1_1_5_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.5.I1"
)
C3_AH1_1_6_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.6.I1"
)
C3_AH1_1_7_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.7.I1"
)
C3_AH1_1_8_I1 = Cavity(
    l=0.346, v=0.0024999884, freq=3.9e9, phi=180.0, eid="C3.AH1.1.8.I1"
)
