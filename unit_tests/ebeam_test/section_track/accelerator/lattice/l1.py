...
bb_96_i1 = SBend(
    l=0.5, angle=0.1366592804, e2=0.1366592804, tilt=1.570796327, eid="BB.96.I1"
)
bb_98_i1 = SBend(
    l=0.5, angle=-0.1366592804, e1=-0.1366592804, tilt=1.570796327, eid="BB.98.I1"
)
bb_100_i1 = SBend(
    l=0.5, angle=-0.1366592804, e2=-0.1366592804, tilt=1.570796327, eid="BB.100.I1"
)
bb_101_i1 = SBend(
    l=0.5, angle=0.1366592804, e1=0.1366592804, tilt=1.570796327, eid="BB.101.I1"
)
bb_182_b1 = SBend(
    l=0.5, angle=0.0532325422, e2=0.0532325422, tilt=1.570796327, eid="BB.182.B1"
)
bb_191_b1 = SBend(
    l=0.5, angle=-0.0532325422, e1=-0.0532325422, tilt=1.570796327, eid="BB.191.B1"
)
bb_193_b1 = SBend(
    l=0.5, angle=-0.0532325422, e2=-0.0532325422, tilt=1.570796327, eid="BB.193.B1"
)
bb_202_b1 = SBend(
    l=0.5, angle=0.0532325422, e1=0.0532325422, tilt=1.570796327, eid="BB.202.B1"
)
...
c_a2_1_1_l1 = Cavity(
    ...
    freq=1300000000.0,
    phi=25,
    vx_up=dip_kick * (-5.6813e-05 + 1.0751e-05j),
    vy_up=dip_kick * (-4.1091e-05 + 5.739e-07j),
    vxx_up=(0.00099943 - 0.00081401j),
    vxy_up=(0.0034065 - 0.0004146j),
    vx_down=dip_kick * (-2.4014e-05 + 1.2492e-05j),
    vy_down=dip_kick * (3.6481e-05 + 7.9888e-06j),
