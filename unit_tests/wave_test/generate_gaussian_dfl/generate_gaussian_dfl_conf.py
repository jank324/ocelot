...
def args_array_ref():
    args_array_ref = [
        ret_args(
            1e-10,
            shape=(21, 21, 21),
            dgrid=(1e-3, 1e-3, None),
            power_rms=(0.1e-3, 0.1e-3, 0.01e-6),
            power_center=(0, 0, None),
            power_angle=(0, 0),
            power_waistpos=(0.1e-3, 0),
            wavelength=None,
            zsep=20,
            freq_chirp=0,
            en_pulse=None,
        ...
        ret_args(
            1e-10,
            shape=(21, 21, 21),
            dgrid=(1e-3, 1e-3, 0.04e-6),
            power_rms=(0.1e-3, 0.1e-3, 0.01e-6),
            power_center=(-0.25e-3, -0.25e-3, None),
            power_angle=(0.5e-6, 0.5e-6),
            power_waistpos=(0.1e-3, 0),
            wavelength=None,
            zsep=None,
            freq_chirp=0,
