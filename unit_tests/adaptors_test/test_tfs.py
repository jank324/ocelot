...
from ocelot.adaptors.tfs import MADXLatticeConverter, optics_from_tfs
...
def optics_df():
    ...
    out.headers = {"ENERGY": energy, "EX": 1e-10, "EY": 1e-10, "GAMMA": relgamma}
...
def test_optics_from_tfs(optics_df):
    ...
    twiss_df_keys_to_twiss_instance_keys = {
        "ALFX": "alpha_x",
        "ALFY": "alpha_y",
        "BETX": "beta_x",
        "BETY": "beta_y",
