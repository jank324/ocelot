...
wig = wigner_dfl(dfl, method="mp", pad=1)
...
w_scan = dfl_waistscan(dfl, z_pos=np.linspace(-20, 20, 15), projection=0)

plot_dfl_waistscan(w_scan, fig_name="waist scan results", showfig=True, savefig=False)
