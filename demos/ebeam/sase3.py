...
def sase3_segment(n=0):
    return (und, d2, qd, psu) + n * cell_ps
...
b1_c = Hcor(l=0.2, angle=1.0e-5, eid="b1_c")
b2_c = Hcor(l=0.2, angle=-1.0e-5, eid="b2_c")
...
sase3_ss = (
    ...
    + sase3_ss_2m
    + sase3_ss_3
    + (d1_c, b1_c, d2_c, b2_c, d3_c, b2_c, d2_c, b1_c, d1_c, qf, psu)
    + sase3_ss_3
)
...
beam.I = 1.0e-9 * beam.C / (np.sqrt(2 * pi) * beam.tpulse * 1.0e-15)
