...
colors = [
    (181 / 256, 101 / 256, 29 / 256),
    (250 / 256, 228 / 256, 170 / 256),
    (7 / 256, 0 / 256, 14 / 256),
]  # R -> G -> B
cmap_name = "serval"
cmap_serval = matplotlib.colors.LinearSegmentedColormap.from_list(
    cmap_name, colors, N=256
)

# ocelot colormap
colors = [
    (255 / 256, 213 / 256, 199 / 256),
    (181 / 256, 101 / 256, 29 / 256),
    (7 / 256, 0 / 256, 14 / 256),
]  # R -> G -> B
cmap_name = "ocelot"
cmap_ocelot = matplotlib.colors.LinearSegmentedColormap.from_list(
    cmap_name, colors, N=256
)
